...
let slidesIndex = 1,
    images = document.querySelectorAll('.another-goods__img'),
    prev = document.querySelector('.stock-slider__prev'),
    next = document.querySelector('.stock-slider__next');
...
function showSlides(n) {
  ...
  if (n > images.length) {
    slidesIndex = images.length;
  }
  
  images.forEach((image) => image.style.display = 'none');
  images[slidesIndex-1].style.display = 'block';
}
